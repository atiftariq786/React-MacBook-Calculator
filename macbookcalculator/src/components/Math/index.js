...
class Math extends Component {
  ...
  operatorHandler = (operator) => {
    ...
    if (this.state.prevOperator === "+") {
      ...
      resultAll =
        ...
        parseFloat(this.state.currentNumericInput);
    }
    //Subtraction------------------------------
    ...
    if (operator === "+/-") {
      ...
      let positiveNegResult = (
        parseFloat(this.state.currentNumericInput) * -1
      ).toString();
  ...
  numericHandler = (num) => {
    ...
    let checkNumeric =
      this.state.currentNumericInput.toString() + num.toString();
